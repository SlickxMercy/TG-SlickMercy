...
def mostrar_menu():
    ...
    # Mostrar el logotipo
    logo = text2art("SlickMercy")  # Reemplaza "Tu Logo" con tu propio texto
    print(Fore.CYAN + logo)

    # Opciones del menú con color
    print(Fore.GREEN + "Elige un script para ejecutar:")
    print(Fore.YELLOW + "1. Escaner")
    print(Fore.MAGENTA + "2. Desencriptar Camaras")
    print(Fore.CYAN + "3. BruteForce Cam")
